<template>
  <div class="w-full bg-brandprimary-purple dark:bg-brandprimary-lightblue">
    ...
    <div class="md:p-40 p-10 block max-w-7xl mx-auto z-1">
        ...
        <h3 class="text-6xl md:text-7xl leading-snug text-left text-grayscale-white font-normal">Dit vinden wij bij <span class="font-bold text-grayscale-white">Colab</span> interessant.</h3>
...
<div class="mt-40 mb-40 grid md:grid-cols-2 gap-20 p-10">
    <div class="self-center">
      <div class="text-4xl font-black dark:text-grayscale-white">De onderwerpen die dagelijks voorbij komen.</div>
